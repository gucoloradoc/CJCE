\documentclass[CJCE,STIX2COL]{WileyNJD-v2}
%%\documentclass[CJCE,STIX2COL]{WileyNJD-v2}
...
\abstract[Abstract]{This is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text this is sample abstract text.}
...
\ctitle{A regime analysis of Atlantic winter jet variability applied to evaluate HadGEM3-GC2}, \cjournal{Q.J.R. Meteorol. Soc.}, 2017;00:1--6.}

\abbreviations{\textbf{Abbreviations:} ANA, anti-nuclear antibodies; APC, antigen-presenting cells; CCA, common carotid artery; CI, confidence interval; EBD, Evans blue dye; IRF, interferon regulatory factor; UBM, ultrasound biomicroscopy.}

\titlenotes{This is an example for title footnote.}
...
%%Lorem ipsum dolor sitamet, consectetuer adipiscing elit. In hac habitasse platea dictumst. Integer tempus convallis augue. Etiam facilisis. Nunc elementum fermentum wisi. Aenean placerat. Ut imperdiet, enim sed gravida sollicitudin, felis odio placerat quam, ac pulvinar elit purus eget enim. Nunc vitae tortor. Proin tempus nibh sit amet nisl. Vivamus quis tortor vitae risus porta vehicula.
...
Maecenas viverra nulla in massa (refer Table~\ref{tab1}).

\begin{table*}[t]%
\processtable{This is sample table caption\label{tab1}}{\tabcolsep=10.5pt%
\begin{tabular}{lccD{.}{.}{3}c}
\THEAD{&\multicolumn{2}{c}{\textbf{Spanned heading\tnote{1}}} & \multicolumn{2}{c}{\textbf{Spanned heading\tnote{2}}}\\\cmidrule{2-3}\cmidrule{4-5}
\textbf{col1 head} & \textbf{col2 head}  & \textbf{col3 head}  & \multicolumn{1}{@{}l@{}}{\textbf{col4 head}}  & \textbf{col5 head} \\}
col1 text & col2 text  & col3 text  & 12.34  & col5 text\tnote{1}   \\\tabrowcolor
col1 text & col2 text  & col3 text  & 1.62  & col5 text\tnote{2}   \\
col1 text & col2 text  & col3 text  & 51.809  & col5 text   \\\tabrowcolor
col1 text & col2 text  & col3 text  & 1.62  & col5 text\tnote{2}   \\
...
\begin{table}[t]%
\processtable{This is sample table caption\label{tab2}}{\tabcolsep=6pt%
\begin{tabular}{lcccc}
\THEAD{\textbf{col1 head} & \textbf{col2 head}  & \textbf{col3 head}  & \textbf{col4 head}  \\}
col1 text & col2 text  & col3 text  & col4 text\tnote{$\dagger$}   \\\tabrowcolor
...
%%\begin{sidewaystable*}% this is to be used to span sideways table to textwidth%%
\begin{sidewaystable}%
\processtable{Sideways table caption. For decimal alignment refer column 4 to 9 in tabular* preamble\label{tab3}}{%
\begin{tabular}{lccD{.}{.}{4}D{.}{.}{4}D{.}{.}{4}D{.}{.}{4}D{.}{.}{4}D{.}{.}{4}D{.}{.}{4}D{.}{.}{4}D{.}{.}{4}D{.}{.}{4}D{.}{.}{4}D{.}{.}{4}}%
\THEAD{& \textbf{col2 head} & \textbf{col3 head} & \multicolumn{1}{c}{\textbf{10}} &\multicolumn{1}{c}{\textbf{20}} &\multicolumn{1}{c}{\textbf{30}} &\multicolumn{1}{c}{\textbf{10}} &\multicolumn{1}{c}{\textbf{20}} &\multicolumn{1}{c}{\textbf{30}} &\multicolumn{1}{c}{\textbf{40}} &\multicolumn{1}{c}{\textbf{50}} &\multicolumn{1}{c}{\textbf{60}} &\multicolumn{1}{c}{\textbf{70}} &\multicolumn{1}{c}{\textbf{80}} &\multicolumn{1}{c}{\textbf{90}}\\}
  &col2 text &col3 text &0.7568&1.0530&1.2642&0.9919 &1.3541&1.6108 &1.3541&1.6108 &0.7568&1.0530 &0.7568&1.0530 \\\tabrowcolor
  & &col2 text &12.5701 &19.6603&25.6809&18.0689 &28.4865&37.3011 &28.4865&37.3011 &12.5701 &19.6603 &12.5701 &19.6603 \\
3 &col2 text  & col3 text &0.7426&1.0393&1.2507&0.9095&1.2524&1.4958 &1.2524&1.4958 &0.7426&1.0393 &0.7426&1.0393 \\\tabrowcolor
  & &col3 text &12.8008&19.9620&26.0324&16.6347&26.0843&34.0765 &26.0843&34.0765 &12.8008&19.9620 &12.8008&19.9620 \\
  & col2 text & col3 text &0.7285&1.0257&1.2374&0.8195 &1.1407&1.3691 &1.1407&1.3691 &0.7285&1.0257 &0.7285&1.0257\tnote{*} \\\tabrowcolor
  & & col3 text &13.0360&20.2690&26.3895&15.0812&23.4932&30.6060 &23.4932&30.6060 &13.0360&20.2690 &13.0360&20.2690\tnote{\dagger} \\
\botrule
\end{tabular}}{\begin{tablenotes}%
...
%%\begin{sidewaysfigure*}%% this is to be used to span sideways figure to textwidth%%
...
\begin{table}[t]%
\processtable{This is an example of Appendix table showing food requirements of army, navy and airforce\label{tab4}}{\tabcolsep=6pt%
\begin{tabular}{lcc}%
\THEAD{\textbf{col1 head} & \textbf{col2 head} & \textbf{col3 head} \\}
col1 text & col2 text & col3 text \\\tabrowcolor
